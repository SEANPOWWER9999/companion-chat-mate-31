  ...
  <section className="py-20 px-4 bg-gradient-to-b from-white to-pink-50">
    <div className="container mx-auto text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        >
          <div className="w-20 h-20 rounded-full bg-pink-100 flex items-center justify-center mb-8 animate-float">
            <Settings className="w-12 h-12 text-pink-400" />
          </div>
          <h3 className="text-2xl font-bold text-gray-800 mb-6">1. Quick Setup 💅</h3>
        ...
        >
          ...
          <h3 className="text-2xl font-bold text-gray-800 mb-6">2. Add Your Magic ✨</h3>
        ...
        >
          ...
          <h3 className="text-2xl font-bold text-gray-800 mb-6">3. Live Your Best Life 💖</h3>
